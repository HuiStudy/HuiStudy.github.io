...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | HuiStudy🥝")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'OL5BZ-SUKLZ-YKXXV-ZT6DE-KJUKQ-ZTBLU',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(113.059806,28.229527, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("10/24/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by HuiStudy🥝 %c 你正在访问HuiStudy🥝の小家",
...
!(function(c,i,e,b){
  ...
  h.crossorigin=true;
  h.onload=function(){new c[b]["Monitor"]().init({id:"3K6dxeqZd0Q4yuR4"});};
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| HuiStudy🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('HuiStudy🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("10/24/2024 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://s1.vika.cn/space/2024/10/30/b7c6275bc460435f813bcf2a3cec1a75' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://s1.vika.cn/space/2024/10/30/00290694b0a34dc2b06fcdd7ec4bc3f4' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
    document.getElementById("workboard") &&
    (document.getElementById("workboard").innerHTML = currentTimeHtml);
}
// 设置重复执行函数，周期1000ms  https://sourcebucket.s3.bitiful.net/badge/F小屋-科研摸鱼中.svg  https://sourcebucket.s3.bitiful.net/badge/F小屋-下班休息啦.svg
setInterval(() => {
  createtime();
}, 1000);
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(/assets/img/background.jpg);
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/HuiStudy/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/HuiStudy/img/home_bg.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/HuiStudy/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/HuiStudy/img/fj1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/HuiStudy/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/HuiStudy/img/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/HuiStudy/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/HuiStudy/img/mb4.webp)')"></a></div>
              </div>
            </details>
